function parcell_aal_rand(dirname, black_hole, dim_low,result_name)
...
%     for i = 1:num_voxels
%         fprintf('%d ',i);
%         labels_new(i,:) = G(i,:) * labels_new;
%         [mv, ind] = max(labels_new(i,:),[],2);
%         labels_new(i,:) = black_hole*ones(1,num_clusters);
%         if mv > 0, labels_new(ind) = 1; end % constructed new labeling
%     end
% end
