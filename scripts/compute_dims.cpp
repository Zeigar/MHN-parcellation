...
int main() {
  ...
  out.open("/fs/nara-scratch/qwang37/brain_data/scripts/dims");
  ...
  // record the keys
  intVector coord;
  out.open("/fs/nara-scratch/qwang37/brain_data/scripts/keyfile");
  ...
  int ind;
  out.open("/fs/nara-scratch/qwang37/brain_data/scripts/coarse_map_file");
